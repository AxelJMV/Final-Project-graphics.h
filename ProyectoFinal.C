...
do{
	...
	inicio:	   
	tecla = bioskey(1); ///a la variable tecla almacena el valor de bioskey(1) de la tecla que se presione
	bioskey(0); // Devuelve el siguiente valor escrito en el teclado -- esperar hasta que se presione una tecla 
